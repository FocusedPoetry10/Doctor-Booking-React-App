        ...
        <div className="container">
           ...
           <div>
            <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingcolor font-[800] md:text-[60px] md:leading-[70px]"> we have patients live a healthy, longer life.
                ...
                <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                   ...
                   [8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full">
                    ...
                    <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]" >
                      ...
                      <h4 className="text-[10px] leading-3 lg:test-[16px] lg:leading-[22px] font-[700] text-headingColor">Dr. VishwaMoorthy</h4> 
                    </div>
