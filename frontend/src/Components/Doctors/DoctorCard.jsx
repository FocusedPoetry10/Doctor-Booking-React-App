...
return(
    ...
    <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        ...
        <Link 
        to={'/doctors/${doctor._id}'} className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none">
